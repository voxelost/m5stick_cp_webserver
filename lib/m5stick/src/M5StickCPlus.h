 ...
 * Hades           2020/07/16         0.0.1          create new library.
 * </pre>
 *
 */
...
public:
    M5StickCPlus();
    void begin(bool LCDEnable = true, bool PowerEnable = true, bool SerialEnable = true, unsigned long SerialBaudRate = 9600);
    void update();
